...
function App() {
  ...
  const state = states[selected.stateIndex];
  const city = state.city[selected.cityIndex];
  const landmark = city.landmarks[selected.landmarkIndex];
